    ...
    return (
            <nav className="navbar navbar-expand-lg custom_navbar">
                <div className="container-fluid">
                    <Link className="navbar-brand custom_brand" href="#">AJ</Link>
                    ...
                    <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
                        <li className="nav-item">
                            <a className="nav-link active custom_menu" aria-current="page" href="#">Home</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link custom_menu" href="#">About</a>
                        </li>
